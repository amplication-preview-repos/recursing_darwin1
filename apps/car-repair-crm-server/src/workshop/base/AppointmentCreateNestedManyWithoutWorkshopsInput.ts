...
@InputType()
class AppointmentCreateNestedManyWithoutWorkshopsInput {
...
export { AppointmentCreateNestedManyWithoutWorkshopsInput as AppointmentCreateNestedManyWithoutWorkshopsInput };
